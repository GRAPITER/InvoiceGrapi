...
export const onbordingSchema = z.object({
  firstName: z.string().min(2, "first name will be greater than 2"),
  lastName: z.string().min(2, "last name will be greater than 2"),
  address: z.string().min(2, "address will be greater than 2"),
});
